...
import { Loader2, CheckCircle2, IndianRupee, AlertCircle, QrCode, X } from 'lucide-react';
...
const MERCHANT_VPA = "opentry@razorpay";
const STORAGE_KEY = 'opentry_pending_payment';
...
export function PaymentQRModal({ isOpen, onClose, onPaymentComplete, template }: PaymentQRModalProps) {
  ...
  }, [cleanupIntervals, toast, onPaymentComplete]);
      ...
      <DialogContent className="sm:max-w-lg p-0 overflow-hidden bg-gradient-to-br from-background via-background to-muted/30 border-0">
        ...
        {paymentStatus === 'completed' ? (
          <div className="flex flex-col items-center justify-center py-16 px-8">
            ...
            <p className="text-muted-foreground text-center">Starting video generation...</p>
          </div>
          ...
          <div className="flex flex-col">
            <div className="text-center pt-8 pb-4 px-6">
              ...
              <p className="text-sm text-muted-foreground mt-1">for {template.name} video generation</p>
            </div>

            <div className="px-6 pb-4">
              <div className="relative mx-auto max-w-[240px]">
                {shortUrl ? (
                  <div className="bg-card rounded-2xl p-5 shadow-lg flex items-center justify-center">
                    <QRCodeSVG 
                      value={shortUrl}
                      size={190} 
                      level="H"
              ...
              <p className="text-center text-sm text-muted-foreground mt-4">Scan with any UPI app to pay</p>
            </div>
            ...
            <div className="px-6 pb-8">
              ...
              <p className="text-center text-xs text-muted-foreground mt-3">Payment will be automatically verified</p>
            </div>
